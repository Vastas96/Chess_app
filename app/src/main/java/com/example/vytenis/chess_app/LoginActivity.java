...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(username, password, mBoundService);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String username, String password, SocketService service) {
            mUsername = username;
            mPassword = password;
            mService = service;
        }
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            mService.sendMessage(mUsername);
            mService.setUsername(mUsername);
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                mPasswordView.setError(getString(R.string.error_failed_login));
